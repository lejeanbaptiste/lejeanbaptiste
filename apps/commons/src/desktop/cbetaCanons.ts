...
export const CBETA_CANON_EDITIONS: Record<string, CbetaCanonEdition> = {
  ...
  X: {
    edition: '卍新纂大日本續藏經 (Manji Shinsan Dai Nihon Zokuzōkyō)',
    editionDate: '1975–1989',
  },
  ...
  N: {
    edition: '漢譯南傳大藏經 (元亨寺版) (Chinese Translation of the Pāli Canon)',
    editionDate: '1990–1998',
  },
