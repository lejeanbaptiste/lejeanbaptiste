...
- Tagging begrenzt auf im Schema verfügbare Optionen
  ...
  Falls Sie auf einen Fehler stoßen oder eine neue Funktion vorschlagen möchten, öffnen Sie bitte ein Ticket unter [https://gitlab.com/calincs/cwrc/leaf-writer/leaf-writer/-/issues](https://gitlab.com/calincs/cwrc/leaf-writer/leaf-writer/-/issues).
