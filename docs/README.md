...
| [autotagging-milestone-projection-planning.md](autotagging-milestone-projection-planning.md)                            | Match/tag across `<lb>`, `<pb>`, and `<choice>`; Phase A projection index shipped |
