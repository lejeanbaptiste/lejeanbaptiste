...
- `<sourceDesc><bibl>` — instance (`W`/`MW`) title, volume label, publisher / place / date when the `MW` carries them, `<idno type="URI">http://purl.bdrc.io/resource/<UT></idno>`, plus `<idno type="BDRC">` for `W`, `MW`, `I`.
