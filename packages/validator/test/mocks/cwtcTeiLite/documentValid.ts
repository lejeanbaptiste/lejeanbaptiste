export const documentValid = `<?xml version="1.0" encoding="UTF-8"?>
...
<TEI xmlns="http://www.tei-c.org/ns/1.0" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
	...
	<text>
		<body>
			<div type="letter">
				<head>
					<title>Sample Letter - Bertrand Russell to <persName cert="low" ref="279399399">Patricia Spence</persName> - October 21, 1935 :)- 9</title>
				</head>
				<opener>
					<note>
						<p>Bad writing due to shaky train</p>
						<p>In train</p>
						<p><placeName cert="high" ref="http://www.geonames.org/6453366">Oslo</placeName> to Bergen</p>
					</note>
					<dateline>
				...
				<p>I have had no letter from you since I left <placeName cert="high" ref="http://www.geonames.org/2673722">Stockholm</placeName>, but I had a nice _ DOM2 _ one from John in an envelope you had sent him. I had sent him one addressed to Copenhagen but he hadn't used it.</p>
				<p>
					...
					<pb n="2"/>
					of my arrival wrong, and	<choice><sic>when</sic><corr>when</corr></choice>
				...
				<pb n="3"/>
				<p>Bull is a nice young man but incompetent - can't quite stand the communists, but finds the socialists too mild.</p>
				<p>I am unhappily wondering what you are feeling about me.</p>
				<closer>
					<salute>I love you very much -</salute>
					<signed>
						<persName sameAs="http://www.freebase.com/view/en/bertrand_russell">
							<persName cert="high" type="real" ref="http://viaf.org/viaf/36924137">B</persName>
						</persName>
					</signed>
				</closer>
			</div>
