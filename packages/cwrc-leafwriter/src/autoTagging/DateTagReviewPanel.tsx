...
/** Simple accept/reject UI for the tag-dates pass (no resolve editor). */
export interface DateTagReviewPanelProps {
  ...
  autoFocus?: boolean;
  busy?: boolean;
  /** Host-compatible optional props; unused on the tag-only pass. */
  onRecalculate?: () => void;
  refreshing?: boolean;
...
export const DateTagReviewPanel = ({
  suggestions,
  onApply,
  onFocus,
  onDecision,
  ...
  return (
    <Box
      ref={containerRef}
      data-testid="date-tag-review-panel"
      tabIndex={0}
