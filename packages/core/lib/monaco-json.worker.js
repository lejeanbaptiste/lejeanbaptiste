...
/* provided dependency */ var process = __webpack_require__(832);
var _a;
          ...
          queueMicrotask(() => {
            ...
            for (const listener of listeners) {
              if (listener.subscription.isset()) {
                ...
                (_a2 = listener.stack) === null || _a2 === void 0 ? void 0 : _a2.print();
              }
            }
          });
        }
...
/* provided dependency */ var process_process = __webpack_require__(832);
...
var editorSimpleWorker_awaiter = function(thisArg, _arguments, P, generator) {
  function adopt(value) {
    return value instanceof P ? value : new P(function(resolve) {
      resolve(value);
    });
...
/* provided dependency */ var json_worker_process = __webpack_require__(832);
  ...
  var t = { 470: (t2) => {
    ...
    var n = { resolve: function() {
      for (var t3, n2 = "", o = false, i = arguments.length - 1; i >= -1 && !o; i--) {
        var a2;
        i >= 0 ? a2 = arguments[i] : (t3 === void 0 && (t3 = json_worker_process.cwd()), a2 = t3), e2(a2), a2.length !== 0 && (n2 = a2 + "/" + n2, o = a2.charCodeAt(0) === 47);
      }
    ...
    var n;
    if (r2.r(e2), r2.d(e2, { URI: () => d, Utils: () => P }), typeof json_worker_process == "object")
      n = json_worker_process.platform === "win32";
