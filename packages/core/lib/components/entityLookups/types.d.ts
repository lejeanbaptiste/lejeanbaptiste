...
export declare type NamedEntityType = 'person' | 'place' | 'organization' | 'title' | 'rs';
export declare type Authority = 'dbpedia' | 'geonames' | 'getty' | 'lgpn' | 'viaf' | 'wikidata';
export declare type ServiceType = 'nssi' | 'custom';
