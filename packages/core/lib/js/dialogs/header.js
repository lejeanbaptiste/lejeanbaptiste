...
class Header {
  ...
  `).appendTo(parentEl);
            ...
            buttons: [
                {
                    ...
                    click: () => {
                        ...
                        $(`[_tag="${this.writer.schemaManager.getHeader()}"]`, this.writer.editor.getBody()).html(headerString);
                        //@ts-ignore
    ...
    doOpen() {
        let headerString = '';
        const headerEl = $(`[_tag="${this.writer.schemaManager.getHeader()}"]`, this.writer.editor.getBody());
    ...
    destroy() {
        ...
        if (this.$headerDialog)
            this.$headerDialog.dialog('destroy');
    }
}
