...
const titleLevels = [
    ...
    },
    {
        level: 'm',
        type: 'Monographic',
        description: 'Monographic book, collection, single volume, or other item published as a distinct item',
    },
    {
        level: 'j',
        type: 'Journal',
...
class TitleDialog {
    ...
    constructor({ writer, parentEl }) {
        ...
        const idPrefix = this.mappingID === 'orlando' || this.mappingID == 'cwrcEntry'
    ...
    titleLevelField(id) {
        ...
        const valueEncoding = this.mappingID === 'orlando' || this.mappingID == 'cwrcEntry'
            ? 'type' //orlando and cwrcEntry
            : 'level'; //tei & teiLite
        const dataMapping = this.mappingID === 'orlando'
            ? 'TITLETYPE'
...
//# sourceMappingURL=TitleDialog.js.map